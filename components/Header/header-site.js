    ...
    <div class="container space-between"> 
        ...
        <div class="container-mobile-menuicon-logo">
            ...
            <div class="mobile-menu-icon transition-bg-3s border-radius-circle center cursor-pointer">
                <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" class="mobile-menu-icon__svg" height="1em" width="1em"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path></svg>
            </div>

            <!-- mobile logo -->
            <div class="container-mobile-logo transition-bg-3s center border-radius-circle">
                <a href="./index.html" class="container-mobile-logo__link center">
                    <svg viewBox="0 0 35 32" fill="none" class="mobile-logo">
        ...
        <div class="overlay">
            <div class="container-desktop-logo-menu align-items-center">
                ...
                <div class="desktop-logo space-between">
                    <a href="./index.html" class="desktop-logo__link">
        ...
        <div class="container-register-cart-user-panel align-items-center">
            <div class="cart transition-bg-3s">
                <span class="cart__number-of-order border-radius-circle">0</span>

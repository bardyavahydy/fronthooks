...
template.innerHTML = `
    ...
    <div class="container space-between"> 
        ...
        <div class="overlay">
            <div class="container-desktop-logo-menu align-items-center">
                <!-- desktop logo -->
                <div class="desktop-logo space-between">
                    <a href="./index.html" class="desktop-logo__link cursor-pointer">
                        <svg width="140" height="35" fill="none" class="desktop-logo__svg">
                    ...
                    <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" class="desktop-logo__cross-svg cursor-pointer" height="1em" width="1em"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                </div>

                <div class="total-container-menu-and-mobile-register-and-mobile-user-panel">
                
                    <!-- menu items -->
                    <ul class="menu center">
                        <li class="menu__list">
                            <img src="../../imgs/indicator.svg" class="indicator" alt="indicator" data-location="index">
                            <a href="./index.html" class="menu__link transition-color-3s menu__link--home align-items-center">
                        ...
                        <li class="menu__list">
                            ...
                            <a href="./courses.html" class="menu__link transition-color-3s align-items-center">
                        ...
                        <li class="menu__list menu__list--contactUs">
                            ...
                            <span href="" class="menu__link transition-color-3s menu__link--contactUs align-items-center cursor-pointer">
                                ...
                                ارتباط با ما
                                <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" class="menu__contactUs-arrow-svg" height="1em" width="1em"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                            </span>
                            <ul class="menu-contactUs">
                                <li class="menu-contactUs__list">
                                    <a href="https://instagram.com/sahebmohamadi.ir" class="menu-contactUs__link align-items-center">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" class="menu-contactUs__svg ml-svg" height="1em" width="1em">
                                ...
                                <li class="menu-contactUs__list">
                                    <a href="#" class="menu-contactUs__link align-items-center">
                                        <svg viewBox="0 0 24 24" fill="none" class="menu-contactUs__svg ml-svg">
                                            <path d="M3.353 8.95A7.511 7.511 0 0 1 8.95 3.353c2.006-.47 4.094-.47 6.1 0a7.511 7.511 0 0 1 5.597 5.597c.47 2.006.47 4.094 0 6.1a7.511 7.511 0 0 1-5.597 5.597c-2.006.47-4.094.47-6.1 0a7.511 7.511 0 0 1-5.597-5.597 13.354 13.354 0 0 1 0-6.1Z" stroke="currentColor" stroke-width="1.5"></path><path d="M12 15.5v-4" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><circle cx="12" cy="9" r="0.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
                                        </circle>
                                    </svg>
                                    درباره ما
                                    </a>
                                ...
                                <li class="menu-contactUs__list">
                                    <a href="#" class="menu-contactUs__link align-items-center">
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="menu-contactUs__svg ml-svg" height="1em" width="1em">
                                            <g><path fill="none" d="M0 0h24v24H0z"></path><path fill-rule="nonzero" d="M12 20a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0 2C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm-3.11-8.83l-2.498-.779c-.54-.165-.543-.537.121-.804l9.733-3.76c.565-.23.885.061.702.79l-1.657 7.82c-.116.557-.451.69-.916.433l-2.551-1.888-1.189 1.148c-.122.118-.221.219-.409.244-.187.026-.341-.03-.454-.34l-.87-2.871-.012.008z"></path></g>
                                        </svg>
                                        کانال تگلرام
                                    </a>
                                </li>
                    ...
                    <!-- user panel-->
                    <div class="container-mobile-user-panel">
        ...
        <!-- register & cart & profile-->
        <div class="container-register-cart-user-panel align-items-center">
            ...
            <div class="container-desktop-user-panel-profile">
                <div class="desktop-user-panel-profile cursor-pointer center">
                    <svg viewBox="0 0 24 24" fill="none" class="desktop-user-panel-profile__user-svg"><g stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" clip-path="url(#account_svg__a)">
                        <path d="M12 13.8c3.06 0 5.54-2.42 5.54-5.4C17.54 5.42 15.06 3 12 3S6.46 5.42 6.46 8.4c0 2.98 2.48 5.4 5.54 5.4ZM6 21c2.69-4.42 9.24-4.44 11.97-.05L18 21"></path></g><defs><clipPath id="account_svg__a"><path fill="#fff" d="M0 0h24v24H0z"></path></clipPath></defs>
                    </svg>
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" class="desktop-user-panel-profile__arrow-svg" height="1em" width="1em">
                ...
                <div class="desktop-user-panel-profile-menus">
                    ...
                    <ul class="user-profile-menu">
                        <li class="user-profile-menu__list">
                            <a href="./userPanel.html?param=profile" class="user-profile-menu__link align-items-center">
                                <svg viewBox="0 0 22 22" fill="none" class="user-profile-menu__svg">
                                    <path fill="currentColor" d="M20.04 9.719a.75.75 0 0 0-1.5 0h1.5Zm-14.58 0a.75.75 0 1 0-1.5 0h1.5Zm9.053 10.988-.172-.73.172.73Zm-5.026 0 .172-.73-.172.73Zm5.341-15.693-.532.529.532-.529Zm5.64 6.744a.75.75 0 1 0 1.064-1.057l-1.064 1.057ZM9.172 5.014l.532.529-.532-.529Zm-6.704 5.687a.75.75 0 1 0 1.064 1.057l-1.064-1.057Zm7.25 7.62-.737-.14.737.14Zm.02-.104.737.139-.737-.139Zm4.524 0-.737.139.737-.139Zm.02.103.737-.138-.737.138Zm-.29 2.232-.677-.322.677.322Zm-.794-.077a.75.75 0 0 0 1.354.645l-1.354-.645Zm-3.19.077-.677.322.677-.322Zm-.56.568a.75.75 0 0 0 1.354-.645l-1.354.645Zm1.913-4.677-.2-.723.2.723Zm1.278 0 .2-.723-.2.723Zm5.901-6.724v4.918h1.5V9.72h-1.5ZM5.46 14.637V9.72h-1.5v4.918h1.5Zm8.88 5.34a10.18 10.18 0 0 1-4.68 0l-.346 1.46a11.68 11.68 0 0 0 5.372 0l-.345-1.46Zm-4.68 0c-2.457-.58-4.2-2.79-4.2-5.34h-1.5c0 3.24 2.214 6.058 5.354 6.8l.345-1.46Zm5.026 1.46c3.14-.742 5.354-3.56 5.354-6.8h-1.5c0 2.55-1.743 4.76-4.2 5.34l.346 1.46Zm-.39-15.894 6.172 6.215 1.064-1.057-6.171-6.215-1.065 1.057ZM8.64 4.486 2.468 10.7l1.064 1.057 6.172-6.215-1.065-1.057Zm6.722 0c-.652-.657-1.193-1.204-1.68-1.577-.502-.387-1.035-.659-1.681-.659v1.5c.183 0 .397.064.768.348.387.298.847.758 1.528 1.445l1.065-1.057ZM9.704 5.543c.681-.687 1.14-1.147 1.528-1.445.37-.284.585-.348.768-.348v-1.5c-.646 0-1.178.272-1.682.659-.486.373-1.027.92-1.679 1.577l1.065 1.057Zm.752 12.916.019-.103L9 18.079l-.02.103 1.475.277Zm3.07-.103.018.103 1.475-.277-.02-.103-1.474.277Zm-.211 1.874-.117.245 1.354.645.117-.246-1.354-.644Zm-3.984.644.117.246 1.354-.645-.117-.245-1.354.644Zm4.213-2.415c.113.6.032 1.22-.23 1.77l1.355.645c.399-.837.52-1.78.35-2.692l-1.475.277Zm-4.563-.277a4.385 4.385 0 0 0 .35 2.692l1.354-.644a2.884 2.884 0 0 1-.23-1.771l-1.474-.277Zm2.58-1.017c.287-.08.59-.08.877 0l.401-1.445a3.138 3.138 0 0 0-1.678 0l.4 1.445ZM15 18.08a3.024 3.024 0 0 0-2.16-2.36l-.4 1.446c.554.154.978.614 1.086 1.19L15 18.08Zm-4.524.277a1.524 1.524 0 0 1 1.087-1.19l-.401-1.446A3.024 3.024 0 0 0 9 18.079l1.474.277Z"></path>
                                </svg>
                                حساب کاربری
                            </a>
                        ...
                        <li class="user-profile-menu__list">
                            <a href="./userPanel.html?param=courses" class="user-profile-menu__link align-items-center">
                                <svg viewBox="0 0 24 24" fill="none" class="user-profile-menu__svg">
                        ...
                        <li class="user-profile-menu__list">
                            <a href="./userPanel.html?param=orders" class="user-profile-menu__link align-items-center">
                                <svg fill="none" viewBox="0 0 24 24" class="user-profile-menu__svg">
                        ...
                        <li class="user-profile-menu__list">
                            <a href="#" class="user-profile-menu__link align-items-center user-profile-menu__link--logout">
                                <svg stroke="currentColor" fill="none" stroke-width="0" viewBox="0 0 24 24" class="user-profile-menu__svg" height="1em" width="1em">
...
class HeaderSite extends HTMLElement{
    ...
    connectedCallback(){
        ...
        const crossElm = $.querySelector('.desktop-logo__cross-svg')
        const containerMobileLogo = $.querySelector('.container-mobile-logo')
        const contactUsListElm = $.querySelector('.menu__list--contactUs span')
        const indicators = $.querySelectorAll('.indicator')
        const menuContactUs = $.querySelector('.menu-contactUs')
        const menuContactUsArrow = $.querySelector('.menu__contactUs-arrow-svg')
        const mobileRegister = $.querySelector('.mobile-register')
        const mobileRegisterLink = $.querySelector('.mobile-register__link ')
        const containerMobileUserPanel = $.querySelector('.container-mobile-user-panel')
        const userProfileLink = $.querySelector('.mobile-user-panel-dashboard__profile-link')
        ...
        const converAllUsersToArr = async () =>{
            ...
            if(allUsersObj){
                ...
                user = allUsersArr.find(item => item[0] === userToken)
            }
        ...
        containerMobileLogo.addEventListener('click', function(event){
        ...
        mobileRegisterLink.addEventListener('click', function(event) {
            createCircleForBtn(event, this, this.offsetWidth)
        })
        ...
        desktopUserPanelProfile.addEventListener('click', function(event){
            createCircleForBtn(event, this, this.offsetWidth)
        })
        
        desktopRegisterLink.addEventListener('click', function(event) {
            createCircleForBtn(event, this, this.offsetWidth)
        })
        ...
        userProfileMenuLists.forEach(userProfileMenuList =>{
            userProfileMenuList.addEventListener('click', function(event){
                createCircleForBtn(event, this, this.offsetWidth)
                if(!this.querySelector('.user-profile-menu__link--logout')){
                    removeClass(userProfileMenu, 'active')
                }
            })
        })

        userProfileMenuLists.forEach(userProfileMenuList =>{
            userProfileMenuList.addEventListener('contextmenu', function(event){
                createCircleForBtn(event, this, this.offsetWidth)
            })
        })
    }
